<div
	class="w-screen h-screen md:p-24 p-12 font-sans text-label bg-bg-secondary flex flex-col justify-between"
>
	<div class="font-serif">
		<h1 class="text-5xl md:text-7xl text-label leading-tight">
